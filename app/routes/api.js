...
router.get('/overview', auth.public_api(), rateLimit, cache.route('overview', 3600), function(req, res, next) {
    ...
    async.parallel({
        upcoming: function(callback) {
            ...
            }).sort('-eventStartDate').limit(3).exec(function(err, docs) {
                if (err) callback(err);
        ...
        recent: function(callback) {
            ...
            }).sort('eventEndDate').limit(3).exec(function(err, docs) {
                if (err) callback(err);
                else callback(null, docs);
            });
        },
...
//EVENTS
router.route('/events').get(auth.public_api(), rateLimit, cache.route('events'), function(req, res, next) {
    Event.find(function(err, events) {
        if (err) next(err);
        else res.json(events);
    });
}).post(auth.updater(), function(req, res, next) {
    Indicative.validateAll(req.body, Validators.event, Validators.messages).then(function() {
...
router.route('/event/:event_id').get(auth.public_api(), rateLimit, cache.route('event'), function(req, res, next) {
...
//APIKEYS
router.route('/keys').get(auth.admin(), function(req, res, next) {
    APIKey.find(function(err, keys) {
        if (err) next(err);
        res.json(keys);
    });
}).post(auth.admin(), function(req, res, next) {
    Indicative.validateAll(req.body, Validators.api, Validators.messages).then(function() {
...
router.route('/key/:keyid').delete(auth.admin(), function(req, res, next) {
    APIKey.remove({
...
//Staff routes
router.route('/staff').get(auth.public_api(), rateLimit, cache.route('staff'), function(req, res, next) {
    Staff.find(function(err, staff) {
        if (err) next(err);
        res.json(staff);
    });
}).post(auth.updater(), function(req, res, next) {
    Indicative.validateAll(req.body, Validators.staff, Validators.messages).then(function() {
...
router.route('/staff/:staff_id').delete(auth.updater(), function(req, res, next) {
    Staff.remove({
...
//Link routes
router.route('/links').get(auth.public_api(), rateLimit, cache.route('links'), function(req, res, next) {
    Link.find(function(err, links) {
        if (err) next(err);
        res.json(links);
    });
}).post(auth.updater(), function(req, res, next) {
    Indicative.validateAll(req.body, Validators.link, Validators.messages).then(function() {
...
router.route('/links/:link_id').delete(auth.updater(), function(req, res, next) {
    Link.remove({
...
//Map routes
router.route('/maps').get(auth.public_api(), rateLimit, cache.route('maps'), function(req, res, next) {
    Map.find(function(err, map) {
        if (err) next(err);
        res.json(map);
    });
}).post(auth.updater(), function(req, res, next) {
    Indicative.validateAll(req.body, Validators.map, Validators.messages).then(function() {
...
router.route('/maps/:map_id').delete(auth.updater(), function(req, res, next) {
    Map.remove({
...
//Match routes
router.route('/matches').get(auth.public_api(), rateLimit, cache.route('matches'), function(req, res, next) {
    Match.find(function(err, matches) {
        if (err) next(err);
        res.json(matches);
    });
}).post(auth.updater(), function(req, res, next) {
    Indicative.validateAll(req.body, Validators.match, Validators.messages).then(function() {
...
router.route('/matches/:match_id').delete(auth.updater(), function(req, res, next) {
    Match.remove({
...
//Organization routes
router.route('/organizations').get(auth.public_api(), rateLimit, cache.route('organizations'), function(req, res, next) {
    Organization.find(function(err, organizations) {
        if (err) next(err);
        res.json(organizations);
    });
}).post(auth.updater(), function(req, res, next) {
    Indicative.validateAll(req.body, Validators.organization, Validators.messages).then(function() {
...
router.route('/organizations/:organization_id').delete(auth.updater(), function(req, res, next) {
    organization.remove({
...
//Round routes
router.route('/rounds').get(auth.public_api(), rateLimit, cache.route('rounds'), function(req, res, next) {
    Round.find(function(err, rounds) {
        if (err) next(err);
        res.json(rounds);
    });
}).post(auth.updater(), function(req, res, next) {
    Indicative.validateAll(req.body, Validators.round, Validators.messages).then(function() {
...
router.route('/rounds/:round_id').delete(auth.updater(), function(req, res, next) {
    Round.remove({
...
//Social media routes
router.route('/socialmedia').get(auth.public_api(), rateLimit, cache.route('socialmedia'), function(req, res, next) {
    SocialMedia.find(function(err, socialmedia) {
        if (err) next(err);
        res.json(socialmedia);
    });
}).post(auth.updater(), function(req, res, next) {
    Indicative.validateAll(req.body, Validators.socialMedia, Validators.messages).then(function() {
...
router.route('/socialmedia/:socialmedia_id').delete(auth.updater(), function(req, res, next) {
    SocialMedia.remove({
...
//Sponsor routes
router.route('/sponsors').get(auth.public_api(), rateLimit, cache.route('sponsors'), function(req, res, next) {
    Sponsor.find(function(err, sponsors) {
        if (err) next(err);
        res.json(sponsors);
    });
}).post(auth.updater(), function(req, res, next) {
    Indicative.validateAll(req.body, Validators.sponsor, Validators.messages).then(function() {
...
router.route('/sponsors/:sponsor_id').delete(auth.updater(), function(req, res, next) {
    Sponsor.remove({
...
//Team routes
router.route('/teams').get(auth.public_api(), rateLimit, cache.route('teams'), function(req, res, next) {
    Team.find(function(err, teams) {
        if (err) next(err);
        res.json(teams);
    });
}).post(auth.updater(), function(req, res, next) {
    Indicative.validateAll(req.body, Validators.team, Validators.messages).then(function() {
...
router.route('/teams/:team_id').delete(auth.updater(), function(req, res, next) {
    Team.remove({
...
//Event module routes
router.route('/eventmodules').get(auth.public_api(), rateLimit, cache.route('modules'), function(req, res, next) {
    EventModule.find(function(err, eventmodules) {
        if (err) next(err);
        res.json(eventmodules);
    });
}).post(auth.updater(), function(req, res, next) {
    Indicative.validateAll(req.body, Validators.module, Validators.messages).then(function() {
...
router.route('/eventmodules/:eventmodule_id').delete(auth.updater(), function(req, res, next) {
    EventModule.remove({
...
// User stuff
router.route('/users').get(auth.admin(), function(req, res, next) {
    User.find({}, 'username userRights', function(err, users) {
        if (err) next(err);
        res.json(users);
    });
});
router.route('/users/:user_id').delete(auth.admin(), function(req, res, next) {
    User.remove({
    ...
    Indicative.validateAll(req.body, Validators.user, Validators.messages).then(function() {
...
router.route('/images/events/:event_id').post(image.upload.single('file'), function(req, res, next) {
